<?php
$page_title = 'Nova Ocorrência Veicular';
$page = 'ocorrencias';
...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h2>Nova Ocorrência Veicular</h2>
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Cadastro de Ocorrência Veicular</h3>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="placa_veiculo" name="placa_veiculo" class="form-control" data-mask="placa" required>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="modelo_veiculo" name="modelo_veiculo" class="form-control" required>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="marca_veiculo" name="marca_veiculo" class="form-control" required>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="cor_veiculo" name="cor_veiculo" class="form-control">
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea id="local_ocorrencia" name="local_ocorrencia" class="form-control" rows="2" required placeholder="Rua, número, bairro, cidade, estado"></textarea>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea id="descricao_ocorrencia" name="descricao_ocorrencia" class="form-control" rows="5" required placeholder="Descreva detalhadamente o que aconteceu..."></textarea>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="nome_condutor" name="nome_condutor" class="form-control">
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="cnh_condutor" name="cnh_condutor" class="form-control">
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="telefone_condutor" name="telefone_condutor" class="form-control" data-mask="phone">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="numero_bo" name="numero_bo" class="form-control" placeholder="Número do Boletim de Ocorrência">
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea id="providencias" name="providencias" class="form-control" rows="3" placeholder="Descreva as providências tomadas..."></textarea>
                    </div>
                </div>
            </div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById("data_ocorrencia").value = dataHoje;
    document.getElementById("hora_ocorrencia").value = horaAtual;
});
</script>
';
