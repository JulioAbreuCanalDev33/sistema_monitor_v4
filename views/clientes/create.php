            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" id="cnpj" name="cnpj" class="form-control" data-mask="cnpj" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="telefone" name="telefone" class="form-control" data-mask="phone" required>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea id="endereco" name="endereco" class="form-control" rows="3" required placeholder="Rua, número, bairro, cidade, estado, CEP"></textarea>
